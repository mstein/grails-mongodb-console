        ...
        <ul class="nav">
            ...
            <li class="dropdown" ng-show="currentDB != null && !copyingDB && !creatingDB">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="divider"></li>
                    <li><a href="#" ng-click="createCol('create-new-col')"><i class="icon-plus"></i> Create Collection
                    </a></li>
            ...
            <li class="dropdown" ng-show="currentCollection != null && !renamingCol && !creatingCol">
                ...
                <ul class="dropdown-menu">
                    <li><a href="#" ng-click="renameCol('rename-new-col')"><i class="icon-edit"></i> Rename Collection
                    </a></li>
